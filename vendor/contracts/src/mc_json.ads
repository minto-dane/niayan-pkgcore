...
package MC_JSON with SPARK_Mode, Pure is
   ...
   procedure String_Bytes(Data : Bytes; D : Document; N : Index; Value : out Bytes; Used : out Natural; Status : out Outcome) with Global=>null, Always_Terminates, Post => Used <= Value'Length;
